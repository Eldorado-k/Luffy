...
class Bot(Client):
    ...
    async def start(self):
        ...
        print(f"\033[1;96m @{me.username} Demarrage......⚡️⚡️⚡️\033[0m")
        try: [await self.send_message(id, f"**__{me.first_name} à Reᴅemarré avec Succès.....✨️__**") for id in Config.ADMIN]                              
        except: pass
